...
county_interventions_cases_sl <- county_intervention_cases %>% select(admin1, SAH_State_Date, cases, cases_2day_before, cases_week_after, cases_2week_after, cases_4week_after)
                                     
datatable(county_intervention_cases_sl)
...
## After Interventions
![After](/output/state_after_plot.PNG)
